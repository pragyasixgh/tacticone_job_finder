...
SECRET_KEY = 'django-insecure-gw%v%&ggd8t@i5u5ogr11pzq5h^p4m$s#+k^bkd)(cwdh2^&r%'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'job_finder' / 'jobs' / 'templates'],  # Look in 'templates' directory at project level
